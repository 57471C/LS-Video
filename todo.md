...
---
## Fixes ##
- [ ] When CC's are active make the icon glow green. When off, make it glow leave white (if there's captions available). If there is no vtt file for the video make it look dark/disabled
